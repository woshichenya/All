...
try:
    ...
    if "502" in re.status_code:
        res = ["mengwenhao@vdongchina.com", "baidebin@vdongchina.com", "chenjunya@vdongchina.com"]
...
try:
    ...
    if len(go.llq.window_handles)>1:
        go.Jubing_go(2, 2)
...
# print(go.llq.current_window_handle)
    ...
    print("页面报错")
# email("502啦快看看", "html", "", "chenjunya@vdongchina.com")

go.end()
btime=time.time()
print("本次运行时间",btime-atime)